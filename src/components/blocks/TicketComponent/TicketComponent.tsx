...
import {TicketData, TicketSegmentData} from "../../../helpers/AviaSales.ts";

type TicketComponentProps = TicketData;
...
const MemorisedTicketComponent = memo(TicketComponent, ({id: prevId}, {id}) => id === prevId);
export default MemorisedTicketComponent
